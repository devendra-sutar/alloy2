...
install_ubuntu() {
    ...
    # Install Grafana and other necessary packages
...
install_suse() {
    ...
    # Create directory for APT keyrings (for consistency, even though SUSE uses RPM)
    sudo mkdir -p /etc/apt/keyrings
    sudo chmod 0755 /etc/apt/keyrings
...
install_redhat() {
    ...
    # Create directory for APT keyrings (for consistency, even though RedHat uses RPM)
    echo "Creating APT keyring directory..."
    sudo mkdir -p /etc/apt/keyrings
    sudo chmod 0755 /etc/apt/keyrings
